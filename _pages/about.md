...
I have gained hands-on industry experience through internships at **Tencent** (ecommerce recommedation at WXG), **Baidu** (LLM applications in commercial advertising), and **Meituan** (AI product for financial service platform), where I developed practical skills in building and deploying AI systems at scale.
